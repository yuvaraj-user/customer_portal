                    ...
                    <?php
                        ...
                        while ($row = sqlsrv_fetch_array($stmt)) {
                            ...
                            <td class="text-center">
                                <div class="checkbox-wrapper-30">
                                    <span class="checkbox">
                                        <input type="checkbox" name="invoices" value="<?php echo $row['Invoice_No'] ?>" />
                                        <svg class="check-svg">
                                        <use xlink:href="#checkbox-30" class="checkbox"></use>
                                        </svg>
                                    </span>
                            ...
                            <td class="text-center"><?php echo $row['Invoice_Date']->format('d/m/Y') ?></td>
                            <?php
                                            $bag = 0;
                                            $gross_amount = 0;
                                            $discount = 0;
                            ...
                            <td class="text-center single_download">
                            <a class="btn btn-flash-border-primary single_download" 
                                                href="convert_to_pdf.php?ino=<?php echo $invo ?>"><i class="fa-solid fa-download"></i> </a> 
                            </td>
                            </tr>
                            <?php } ?>
                    </tbody>
