...
<!--             <button type="button" class="btn btn-success" style="float: inline-end;font-size: 12px;"
            ...
            <div class="filter-div">
                ...
                <div class="filter-icon-container" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas">
                    <button class="btn btn-primary btn_filter" type="button"><i class="fas fa-filter"></i> Filter</button>
                </div>
            </div>
           ...
           <!--  <div class="container">
            ...
            <section>
                <div class="container tbl_container pt-1 pb-5" >
                    <table class="table table-striped table-bordered table-hover table-responsive dt_table" id= "table-id" style="width:100%;">
...
<script type="text/javascript">
                    ...
                    if(response.length > 0) {
                        ...
                        for(i in response) {
                            ...
                            <td class="text-center">
                                <div class="checkbox-wrapper-30">
                                    <span class="checkbox">
                                        <input type="checkbox" name="invoices" value="${ response[i].Invoice_No }" />
                                        <svg class="check-svg tbl-check-svg">
                                        <use xlink:href="#checkbox-30" class="checkbox"></use>
                                        </svg>
                                    </span>
                                </div>
                            ...
                            <td>${ (response[i].no_of_bags > 0) ? (response[i].invoice_QtyInPkts/response[i].no_of_bags) : 0 }</td>
                            <td>${ parseInt(response[i].invoice_QtyInPkts) }</td>
                            <td>${ response[i].invoice_QtyInKgs }</td>
                            <td>${ response[i].invoice_NetAmount }</td>
                            <td class="text-center single_download" data-invoiceno="${ response[i].Invoice_No }"><i class="fa-solid fa-download"></td>
                            </tr>`;
                        }
        ...
        // function get_card_credit_note(data)
        // {
        //     $.ajax({
        //         url: 'common_ajax.php',
        //         type: 'POST',
