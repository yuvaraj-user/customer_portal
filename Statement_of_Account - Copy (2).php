...
<section>
	...
	<!-- <div class="card filter-bg">
	    ...
	    <div class="d-flex justify-content-end">
	        <i class="fas fa-filter" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas" style="cursor: pointer; font-size: 24px;"></i>
	    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(document).on('click','#filterModal',function(){
			console.log('Yes')
